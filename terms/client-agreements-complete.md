# Kinetic Hustl — Client Agreements (complete text)

> **Generated file — do not edit by hand.** Produced by `generate-templates.js` from the same
> clause text as the ten `.docx` templates, so this file and the documents clients sign always match.
> Change wording in the script and re-run it.

Everything a client agrees to, across all ten agreements, in one file. Safe to quote to a client.
Rates here mirror `pricing-rates-and-terms.md`; if the two ever disagree, the rates file wins.

**Health screening form** (everyone, before the first session)**:** https://forms.gle/T8yaRciEND7FJ2mU8

**Terms and conditions form** (on sign-up)**:** https://forms.gle/EQy9Ly2KgeZmShJe7

Clients accept these terms and confirm their rate by completing that form. It records their details,
health information, consent, policy acknowledgements and agreed rate, and emails them a copy.

**Kinetic Hustl. — Karl Hoschke  ·  ABN 51 607 358 310  ·  Fitaz Gym, 101 Main Street, Kangaroo Point QLD 4169  ·  khoschke@gmail.com  ·  0434 869 519**
...
| Agreement | Rate |
| --- | --- |
| Personal Training — 1-on-1, Weekly · With App Access | $88 per session, plus $22 per week |
| Personal Training — 1-on-1, Weekly · Without App Access | $110 per session |
| Personal Training — 1-on-1, Flexi (fortnightly) · With App Access | $104.50 per session, plus $44 per fortnight |
| Personal Training — 1-on-1, Flexi (fortnightly) · Without App Access | $126.50 per session |
| 2-on-1 Training — maximum two participants · With App Access | $66 per session, plus $22 per week |
| 2-on-1 Training — maximum two participants · Without App Access | $88 per session |
| Group Training — maximum three participants · With App Access | $55 per session, plus $22 per week |
| Group Training — maximum three participants · Without App Access | $77 per session |
| Online Coaching | $44 per week, casual sessions $121 |
| Casual Personal Training | $143 per session |

A client's tier is set by their agreement, not by how many sessions fall in a given fortnight.
Additional and rescheduled sessions are charged at the agreed rate and do not change it.

---

## Terms common to every agreement
...
### Training and cancellation policies
...
**Change to group size.** If a participant gives notice or leaves, the Trainer will tell you as soon as they know and confirm in writing the rate that would apply to the new group size. You will have at least two weeks' notice before any new rate takes effect, and the Trainer will use that time to look for a replacement. Your rate does not change unless you agree to the new rate in writing. If you would rather not continue at the new rate, you may end this agreement at that point with no further notice period and no fee.

**Separate agreements.** Each participant holds their own agreement and their own payment arrangement. Participants are not jointly responsible for one another's fees.

### Your information

*With app access:* To coach you I collect personal details, health and medical information, training records and body composition measurements. This information is used to design and adjust your program and to manage your account. It is stored in the training app and in my own records. The app is operated by a third-party provider, so your information is held on their systems as well as mine.

*Without app access:* To coach you I collect personal details, health and medical information, training records and body composition measurements. This information is used to design and adjust your program and to manage your account. It is stored in my own records.
...
Progress photos are taken for your own tracking. They are stored with your records and are never shared or published without your consent.

Separately, I sometimes take photos or video in the gym for social media and marketing. This is entirely optional and does not affect your training in any way. You can withdraw your consent at any time by telling me: I will stop using new material and remove existing material wherever it is practical to do so.

The client ticks one: “I consent to photos and video of me, including progress photos, being used in Kinetic Hustl marketing and social media.” or “I do not consent.”

### Minimum term and signatures

A minimum term of 12 weeks applies unless otherwise agreed in writing. Casual agreements carry no minimum term.

Every agreement is signed by both the client and the trainer, each dated.

---

## The ten agreements

### Personal Training — 1-on-1, Weekly · With App Access

`KH-Terms-1-on-1-Weekly-With-App-Access.docx`

| Frequency | Rate per session |
| --- | --- |
| Weekly | $88 |
...
### Personal Training — 1-on-1, Weekly · Without App Access

`KH-Terms-1-on-1-Weekly.docx`
...
### Personal Training — 1-on-1, Flexi (fortnightly) · With App Access

`KH-Terms-1-on-1-Flexi-With-App-Access.docx`

| Frequency | Rate per session |
| --- | --- |
| Flexi (fortnightly) | $104.50 |

This agreement includes access to the Kinetic Hustl App at $22 per week (GST incl.), charged in addition to your session rate. App access is charged per week, so each fortnightly debit includes two weeks of it ($44).
...
### Personal Training — 1-on-1, Flexi (fortnightly) · Without App Access

`KH-Terms-1-on-1-Flexi.docx`

| Frequency | Rate per session |
| --- | --- |
| Flexi (fortnightly) | $126.50 |
...
### 2-on-1 Training — maximum two participants · With App Access

`KH-Terms-2-on-1-With-App-Access.docx`

| Item | Rate per person, per session |
| --- | --- |
| 2-on-1 set rate | $66 |
...
| Additional session | Rate |
| --- | --- |
| 2-on-1 | $66 |
| 1-on-1 | $88 |

The three shared-format policies above apply to this agreement.

---

### 2-on-1 Training — maximum two participants · Without App Access

`KH-Terms-2-on-1.docx`
...
### Group Training — maximum three participants · With App Access

`KH-Terms-3-on-1-With-App-Access.docx`
...
### Group Training — maximum three participants · Without App Access

`KH-Terms-3-on-1.docx`
...
| Additional session | Rate |
| --- | --- |
| 45-minute Personal Training session | $121 |

---

### Casual Personal Training

`KH-Terms-Casual.docx`

| Item | Rate per session |
| --- | --- |
| Casual session | $143 |
